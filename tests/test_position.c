...
int test_position(char *fen_str, info expected_pstn, char *expected_str){
...
int main(void) {
    ...
    char expected_strings[N_TESTS][92] = {
        "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
        "rnbqkbnr/1p1ppppp/8/p1pP4/8/8/PPP1PPPP/RNBQKBNR w KQkq c6 0 1",
        "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1",
        "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1",
        "r3k2r/p1ppqpb1/bn2pnp1/3PN3/4P3/1pN2Q1p/PPPBBPPP/R3KR2 w Qkq - 0 1",
        "r3k2r/8/8/7b/8/8/1B2K1BQ/R6R w kq - 3 1",
        "r1b1k1nr/ppp2ppp/2n5/3p4/4p2q/PPP2Pb1/R2PP2P/1NBQKBNR w Kkq - 0 1",
        "r3k2r/pppbbppp/2n4P/1P2p3/3p4/BN2PqP1/P1PPQnB1/R2K3R w kq - 0 1",
        "4k2r/8/8/8/8/8/8/R1r1K2R w KQk - 1 1",
        "r3k2r/pppb1ppp/2n2q1P/1P2p3/1b2n3/BN1P1NP1/P1PQ1pB1/R3K2R w KQkq - 0 1",
        "8/8/3p4/1Pp4r/1K3R2/6k1/4P1P1/8 w - c6 0 1",
        "rnbqkbn1/pp6/8/8/4Kr2/8/PP4b1/R3Q1BR w q - 0 1",
        "r5k1/ppp3p1/3pb3/7p/8/5r1K/PB3bPP/RN1Q3R w - - 0 1",
        "r1b1k2r/pp3pp1/2n5/1B1N2q1/3PpP2/4n1pK/PP2N3/R1BQ1R2 w kq - 0 1",
        "r3k2r/p1ppqpb1/bn2pnp1/1B1PN3/1p2P3/2N2Q1p/PPPB1PPP/R3K2R w KQkq - 0 1"
    };
    ...
    info results[N_TESTS] = {
        ...
        {.side = WHITE, .c_rights = 12, .ep_square = 0, .h_clk = 3, .check_info = DISTANT_CHECK | (0x8B << 2)},
        {.side = WHITE, .c_rights = 14, .ep_square = 0, .h_clk = 0, .check_info = DISTANT_CHECK | (0x6A << 2)},
        {.side = WHITE, .c_rights = 12, .ep_square = 0, .h_clk = 0, .check_info = CONTACT_CHECK | (0x59 << 2)},
        {.side = WHITE, .c_rights = 11, .ep_square = 0, .h_clk = 1, .check_info = DISTANT_CHECK | (0x46 << 2)},
        {.side = WHITE, .c_rights = 15, .ep_square = 0, .h_clk = 0, .check_info = CONTACT_CHECK | (0x59 << 2)},
        ...
        {.side = WHITE, .c_rights = 12, .ep_square = 0, .h_clk = 0, .check_info = DOUBLE_CHECK | (0xB6 << 2) | (0xBB << 10)},
        {.side = WHITE, .c_rights = 15, .ep_square = 0, .h_clk = 0, .check_info = 0}
    };
    ...
    for (int i = 0; i < N_RUN; i++) {
        if (test_position(fen_strings[i], results[i], expected_strings[i]) == 0) {
